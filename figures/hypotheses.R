...
# 
legend('topright',legend = c('Onset of Brown-down',
                             'Low growth sensitivity; Low turnover sensitivity', 
                             'Low growth sensitivity; High turnover sensitivity',
                             'High growth sensitivity; Low turnover sensitivity',
                             'High growth sensitivity; High turnover sensitivity'),bty='n',
       pch=c(3,rep(NA,4)),
       lty = 1,lwd=3,
       col = c('grey',palette()))
