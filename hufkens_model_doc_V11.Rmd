...
In the original Hufkens model (V00), growth happens 2-3 days after rainfall but last only for one day. This assumption seems not supported by our PACE data. Instead, we change the growth to the continuous two days after rainfall. In V00, the growth rate is related to the laged water availibility (i.e., that of 3 days ago), and senescense rate is indepedent of growth. In V11,
