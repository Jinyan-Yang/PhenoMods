...
In the original Hufkens model (V00), growth happens as long as growth rate is higher than senesence rate. i.e. growth and senescence can happen at the same time. This lead to issueof fitting par values.

This assumption seems not supported by our PACE data. Instead, we change the growth to the continuous two days after rainfall. In V00, the growth rate is related to the laged water availibility (i.e., that of 3 days ago), and senescense rate is indepedent of growth. In V11,
